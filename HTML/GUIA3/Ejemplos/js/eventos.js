function iniciar(){
    ...
    /*Definir objetos sobre los que se escucharan los eventos y asociar los eventos correspondientes
    */
   //primera caja de textov
   var textFielFocus=document.frmEjemplo.txtfoco;
   textFielFocus.onfocus=foco;
   //segunda caja de texto
   var textFielKey =document.frmEjemplo.txttecla;
