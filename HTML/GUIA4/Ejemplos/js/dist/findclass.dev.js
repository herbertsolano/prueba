...
function findClassInElements(className, type) {
  ...
  var elems = document.getElementsByTagName(type || "*"); //En este caso el patrón de la expresión regular incluirá una variable,
  //por lo tanto estará obligado a usar el contructor RegExp.

  var regex = new RegExp("(^|\\s)" + className + "(\\s|$)");
  var results = new Array(); //El ciclo recorre toda la página comprobando en el elemento enviado a la función
